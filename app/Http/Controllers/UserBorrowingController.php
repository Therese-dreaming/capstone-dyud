...
class UserBorrowingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'custom_building' => 'required_with:location_id,custom|string|max:255',
            'custom_floor' => 'required_with:location_id,custom|string|max:255',
            'custom_room' => 'required_with:location_id,custom|string|max:255',
