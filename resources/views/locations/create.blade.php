...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-lg p-10">
    <h2 class="text-2xl font-bold mb-8 text-gray-800 flex items-center gap-3">
        <i class="fas fa-plus-circle text-red-800"></i> Add Location
    </h2>
    @if(session('success'))
    ...
    <form action="{{ route('locations.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="building" id="building" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-red-800" value="{{ old('building') }}" required>
        </div>
        <div class="mb-6">
            <label class="block text-gray-700 font-semibold mb-2" for="floor">Floor</label>
            <input type="text" name="floor" id="floor" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-red-800" value="{{ old('floor') }}" required>
        </div>
        <div class="mb-6">
            <label class="block text-gray-700 font-semibold mb-2" for="room">Room</label>
            <input type="text" name="room" id="room" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-red-800" value="{{ old('room') }}" required>
        </div>
