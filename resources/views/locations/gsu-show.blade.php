...
<div class="container mx-auto py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('gsu.assets.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 flex items-center gap-2">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($assets as $asset)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $asset->category->name ?? 'N/A' }}</td>
