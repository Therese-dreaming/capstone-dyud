                ...
                @if($currentSemester)
                    <div class="bg-blue-50 border border-blue-200 rounded-lg px-3 py-2">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <div class="text-xs text-blue-600 font-medium">Registering for</div>
                                <div class="text-sm font-semibold text-blue-800">{{ $currentSemester->academic_year }} - {{ $currentSemester->name }}</div>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg px-3 py-2">
                        <div class="flex items-center gap-2">
                            ...
                            <div class="text-sm text-yellow-800">No active semester found</div>
                        </div>
                    </div>
                @endif
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                    ...
                    <div class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 flex items-center">
                        ...
                        <span class="text-gray-600 font-medium text-sm">Auto-generated</span>
                    </div>
                    <p class="mt-1 text-xs text-gray-500">
                        <i class="fas fa-info-circle mr-1"></i>
                        Unique codes will be assigned
                    </p>
                </div>
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 @error('quantity') border-red-500 ring-2 ring-red-200 @enderror">
                    @error('quantity')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">
                        <i class="fas fa-qrcode mr-1"></i>
                        Each asset gets a unique QR code
                    </p>
                </div>
            </div>
