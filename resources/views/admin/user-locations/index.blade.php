...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-600 to-purple-700 rounded-full mb-4">
                <i class="fas fa-users text-white text-2xl"></i>
            </div>
            <h1 class="text-4xl font-bold text-gray-900 mb-2">User Location Assignments</h1>
            <p class="text-lg text-gray-600">Manage which users can access specific locations</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-white">Assign User to Location</h2>
                        <p class="text-green-100">Grant location access to users</p>
                    </div>
                </div>
            </div>
            <div class="p-6">
                <form method="POST" action="{{ route('admin.user-locations.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="flex justify-end">
                        <button type="submit" 
                            ...
                            <i class="fas fa-plus mr-2"></i> Assign Location
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-purple-100">Active user-location assignments</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-2xl font-bold text-white">{{ $assignments->total() }}</div>
                        <div class="text-purple-100 text-sm">Total Assignments</div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-12 text-center">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-500">Start by assigning users to locations using the form above.</p>
                </div>
            </div>
            @endif
        </div>
