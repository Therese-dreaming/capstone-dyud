    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white shadow-xl flex flex-col transition-all duration-300" x-data="{ expanded: true }">
                        ...
                        <ul x-show="open" x-transition class="ml-8 mt-2 space-y-1" style="display: none;">
                            ...
                            <li>
                                <a href="{{ route('dashboard') }}"
                                   class="flex items-center px-3 py-2 text-sm rounded hover:bg-red-100 hover:text-red-800 {{ request()->routeIs('dashboard') ? 'bg-red-100 text-red-800' : 'text-gray-600' }}">
            ...
            <div class="p-4 border-t border-gray-100">
                ...
                <div class="flex items-center px-4 py-2.5 mt-2">
                    <i class="fas fa-moon w-5 text-gray-600"></i>
                    <span class="ml-3 flex-1" x-show="expanded">Dark Mode</span>
